...
def filt(df_input,minsampling,logger,config):#Jue changed df to df_input, so we do not have confusion over df_input and df (output)
    df=df_input.copy(deep=True)#Jue added this line
